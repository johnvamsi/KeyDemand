...
public class Brokenlinks1 {
	...
	public static void main(String[] args) throws IOException {
		...
		for(WebElement linkEle:links)
		{
			...
			//URLConnection connect=linkurl.openConnection();	
					// below command will opens the connection and we store this connection into an variable
			HttpURLConnection conn=(HttpURLConnection) linkurl.openConnection(); ////send request to server - open , connect
			conn.connect();//here we will connect the url to connection server
